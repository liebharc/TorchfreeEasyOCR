...
MODULE_PATH = os.environ.get("TORCHFREE_OCR_MODULE_PATH") or \
              os.environ.get("MODULE_PATH") or \
              os.path.expanduser("~/.TorchfreeOCR/")
...
character_folder = {
    'url': 'https://github.com/SeldonHZ/TorchfreeEasyOCR/releases/download/pre-v1.1.0/character.zip',
}

character_md5sum = ['c42960f947191ddeb204f46b9cf0952b', '676d355beadd729a2b6632253d2401ea', 'f6d4814a29e6d63780b6690eab287fbb', '834a610abfe657f9bef0e59f33d0e880', '660abe8a4cd742a00d264d13afa1631b', '6bad2b7e9ace6302b11ef8e5163c4eb2', '2a4b0391dc65e0bce716e0469664ef30', '300165ab7744cd633a7b6146a1896e84', 'd42e48d25484f98aacac0c435bdeaf72', '676d355beadd729a2b6632253d2401ea', '88a7e627dd7f02e7eda23e20b9e57a50', 'fe9ca68e9a517c8bbcc1c9f01523e045', '9d012ed2fdb07b7523414a46e767f77f', '2a4b0391dc65e0bce716e0469664ef30', '2a4b0391dc65e0bce716e0469664ef30', 'd42e48d25484f98aacac0c435bdeaf72', 'ba404a2e5141a080f677fa01013a1188', 'e6a212966346e9720193f6fda06650a7', 'f4f2140ab8ac6f7f6c2c0436614bb6ac', '93b82186a26aea056f96bce5f8d7304e', '0a8fb4d9c75a64b627fa77bd7bee7105', '676d355beadd729a2b6632253d2401ea', '6ce413993d93711b7ca99625279f9eb2', 'ae9f8ba521acaf0eca769e501eabb202', '956fdc247d9f150122263b220883d220', '676d355beadd729a2b6632253d2401ea', '6a76d2fefaf60bb5b953eabf27b1f533', '19323d058ace799d381569ce2adc79e9', 'ca6f188442059be6843e18b6dfc62f75', '204dabc4b091688f5950e7946e27a1a4', 'c9a939ec116374eb4151024697ef61e9', '00f05d53d1a3525ab53308f9fd7f132e', '6c70842f4f0013768ac84cb41fb68876', 'e23982f39ab261b0cbc961386223c571', '2a4b0391dc65e0bce716e0469664ef30', '83d87cd5b95f376dc5f325696907aa0f', '482c7660233a0e8982e1acf57ab0c889', '2a4b0391dc65e0bce716e0469664ef30', '3dd6d1e8957a23a76667c74db402de2c', '1de092176dbcecdbc86641b9820e9a33', 'd36591af7d4b7a2be07c933353f4ef3a', '676d355beadd729a2b6632253d2401ea', '5ef528363c30c43aea8db3bb646467c4', '027dc0b27a8c0024791b1009795fd53e', 'b3cfaa6ff5b76f8f99a133ab23025fbe', '3372e0883cb464843771b995307bb3db', '676d355beadd729a2b6632253d2401ea', '0effcef2d314596f7f57640f296c96f5', '2be2e51ebf5b38085430f8378799cf8f', '05ff47371a827959d369b28dbe89b37d', '4366b3658c474c28b9a1eb07ba81bfdd', 'bd9ff39f0737e7f8d60972c14fb76c68', '676d355beadd729a2b6632253d2401ea', '676d355beadd729a2b6632253d2401ea', 'ac6b8e9dcb37ef04153f30abb0fce974', 'cf95752b698df52332fe65b313ad2519', '2a4b0391dc65e0bce716e0469664ef30', '2a4b0391dc65e0bce716e0469664ef30', '25ec1516714c4e0ba5ee2651b3dfa602', '30625460e34686b3a5a0aa37e7bdff78', '918edb726ff08ab93ea34d985783d7bd', '9d0beda8ca9f03d9f0af5453679930d7', '4a7db5d56d5f356e8459c55519a51fd0', '312ca23e69908ddaa7d5fb849cc58d98', 'f4eb45c751298f1d8599cb4ea51e6639', '66dd102aa7e5b9c49aa149ac0930270d', '2a4b0391dc65e0bce716e0469664ef30', 'b1c28b2fa1cb0fcae11157797c704b39', '95cc6f36752cd96d4914c0001671d672', '3f21fbb83457a1cfdb9b82929a6eb225', '5fd0b77e2eff7e501bcdaf12f291acbd', '0c5f4b2eb5ec4c2f186d71caf6c3cb0d', 'aa01e280493d51d3e6a77c98d449ae15', 'db79d064c7cbbc8d2aa9609ca0384e14', '931a0736e72191bbcce05b43a6869179', '8b576fd90ffc5642bcfcb9d4846529b9', '6412f713c6c5c2866a8b5ede671085e5', 'f732ddfd9892b1a19e0bcc104976bfe4', '827507da6f4a13d1640fba15749e1bf4', '38f9339dfe0f35c6f72815744661f078', '1373cd260af40f683bc56d25917659f0', '2a4b0391dc65e0bce716e0469664ef30', 'e0e1f4f8d0085062aca916f121f8f8d4', '3d64da69f36c4c0a1bbcce1b5d0a68a0', '58b9dbf299abd9b8042043e7b314772c', '518cd209534b62a458b8e1bb0c7397a3', 'd61a35609689668b845394aa388a536e', '07087e9d4c62bffc02293e6109019020', 'bdbd0258c6af93bc44c038c23b28e772', '0f0651da1f619d6f9d721ace845627c5', '676d355beadd729a2b6632253d2401ea', 'bcf398cb94ed60cfc72571341fd6880e', 'b7cd07a87ff2b42e02537dfeae6ccb9e', 'a8a3d5c198dcffb44367d09a093a51c4', '792d35fe80677811b8d8c8aedafdfe6b', '48eac75cd0e33e7584f563105f82a468', '448a4638f94a214f5fb8c74923584f77', '754f372c058a8c4f969dec2258ac9b67', '3dfc7d2d01cd0095ec580641f35b5321', 'a295e58185a9c1d38ecc10986ee36148', '05e4394fc75ce53ee0e814bfbac2fde8', '5bd5afa31ea23c5de1fad5bd85d9d03b', '4b684fb4aac91b53cd53cdff895a18d1', 'c25a9dd7c2c0038f883177584536767f']


detection_model = {
    'filename': 'detection.onnx',
    'url': 'https://github.com/SeldonHZ/TorchfreeEasyOCR/releases/download/pre-v1.1.0/detection.zip',
    'md5sum': 'c8fa14f85030d87c52f8990db50d68ef'
}
...
recognition_models = {
    'gen1' : {
        'zh_tra_g1':{
            'filename': 'zh_tra_g1_rec.onnx',
            'model_script': 'chinese_tra',
            'url': 'https://github.com/SeldonHZ/TorchfreeEasyOCR/releases/download/pre-v1.1.0/zh_tra_g1_rec.zip',
            'md5sum': 'e279099f79bc80cbac8dd08f5d036bd5',
        ...
        'thai_g1':{
            ...
            'model_script': 'thai',
            'url': 'https://github.com/SeldonHZ/TorchfreeEasyOCR/releases/download/pre-v1.1.0/thai_g1_rec.zip',
            'md5sum': '15388c67adea8c93b982fc44bcffff53',
            'symbols': "0123456789!\"#$%&'()*+,-./:;<=>?@[\\]^_`{|}~ ",
        ...
        'devanagari_g1':{
            'filename': 'devanagari_g1_rec.onnx',
            'model_script': 'devanagari',
            'url': 'https://github.com/SeldonHZ/TorchfreeEasyOCR/releases/download/pre-v1.1.0/devanagari_g1_rec.zip',
            'md5sum': '1da62421bdb5030085edc7384657706d',
            'symbols': "0123456789!\"#$%&'()*+,-./:;<=>?@[\\]^_`{|}~ ",
        ...
        'arabic_g1':{
            'filename': 'arabic_g1_rec.onnx',
            'model_script': 'arabic',
            'url': 'https://github.com/SeldonHZ/TorchfreeEasyOCR/releases/download/pre-v1.1.0/arabic_g1_rec.zip',
            'md5sum': '05a826cdd2b0b29cbe4133fe274939f6',
        ...
        'tamil_g1':{
            'filename': 'tamil_g1_rec.onnx',
            'model_script': 'tamil',
            'url': 'https://github.com/SeldonHZ/TorchfreeEasyOCR/releases/download/pre-v1.1.0/tamil_g1_rec.zip',
            'md5sum': '7533efcb880154fdb363bdb46f4da1df',
            'symbols': "0123456789!\"#$%&'()*+,-./:;<=>?@[\\]^_`{|}~ ",
        ...
        'bengali_g1':{
            'filename': 'bengali_g1_rec.onnx',
            'model_script': 'bengali',
            'url': 'https://github.com/SeldonHZ/TorchfreeEasyOCR/releases/download/pre-v1.1.0/bengali_g1_rec.zip',
            'md5sum': 'd48ab9b3527f58a56595005678552245',
            'symbols': "0123456789!\"#$%&'()*+,-./:;<=>?@[\\]^_`{|}~ ",
    ...
    'gen2' : {
        'english_g2':{
            ...
            'url': 'https://github.com/SeldonHZ/TorchfreeEasyOCR/releases/download/pre-v1.1.0/english_g2_rec.zip',
            'md5sum': '8deccfa817467f834edb79b39220312e',
            'symbols': "0123456789!\"#$%&'()*+,-./:;<=>?@[\\]^_`{|}~ €",
        ...
        'latin_g2':{
            ...
            'model_script': 'latin',
            'url': 'https://github.com/SeldonHZ/TorchfreeEasyOCR/releases/download/pre-v1.1.0/latin_g2_rec.zip',
            'md5sum': '613a143cb017110c0cbadda32165b580',
            'symbols': " !\"#$%&'()*+,-./0123456789:;<=>?@[\\]^_`{|}~ €",
        ...
        'zh_sim_g2':{
            ...
            'url': 'https://github.com/SeldonHZ/TorchfreeEasyOCR/releases/download/pre-v1.1.0/zh_sim_g2_rec.zip',
            'md5sum': '9ba3fee6bfcca1d590d1cefcd862f43c',
            'symbols': " !\"#$%&'()*+,-./0123456789:;<=>?@[\\]^_`{|}~。〈〉《》「」『』",
        ...
        'japanese_g2':{
            ...
            'url': 'https://github.com/SeldonHZ/TorchfreeEasyOCR/releases/download/pre-v1.1.0/japanese_g2_rec.zip',
            'md5sum': 'c3f65a6ef8fdb9947ae8bfdcf559947d',
        ...
        'korean_g2':{
            ...
            'model_script': 'korean',
            'url': 'https://github.com/SeldonHZ/TorchfreeEasyOCR/releases/download/pre-v1.1.0/korean_g2_rec.zip',
            'md5sum': 'de1a84cab05f9da31851c7e99fe6a62b',
            'symbols': " !\"#$%&'()*+,-./0123456789:;<=>?@[\\]^_`{|}~",
        ...
        'telugu_g2':{
            'filename': 'telugu_g2_rec.onnx',
            'model_script': 'telugu',
            'url': 'https://github.com/SeldonHZ/TorchfreeEasyOCR/releases/download/pre-v1.1.0/telugu_g2_rec.zip',
            'md5sum': 'cb399f7b1933c3bd0f8ae1a62af480ea',
            'symbols': '0123456789!"#$%&\'()*+,-./:;<=>?@[\\]^_`{|}~ ',
        ...
        'kannada_g2':{
            'filename': 'kannada_g2_rec.onnx',
            'model_script': 'kannada',
            'url': 'https://github.com/SeldonHZ/TorchfreeEasyOCR/releases/download/pre-v1.1.0/kannada_g2_rec.zip',
            'md5sum': 'c61cf59571436b3a99476515d2940f4f',
            'symbols': '0123456789!"#$%&\'()*+,-./:;<=>?@[\\]^_`{|}~ ',
        ...
        'cyrillic_g2':{
            'filename': 'cyrillic_g2_rec.onnx',
            'model_script': 'cyrillic',
            'url': 'https://github.com/SeldonHZ/TorchfreeEasyOCR/releases/download/pre-v1.1.0/cyrillic_g2_rec.zip',
            'md5sum': '9a04ae0a410c4e14e468d3993112839e',
            'symbols': '0123456789!"#$%&\'()*+,-./:;<=>?@[\\]^_`{|}~ €₽',
